...
class __TwigTemplate_57beb4da575d3849f7e81ab3664fd44b631edc678c478095f2694970c903a270 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"list-item h-entry uk-flex-top\">
    ...
    ";
        ...
        // line 7
        echo "
    <div class=\"list-blog-header uk-flex-column-reverse uk-width-medium\">
        ...
        if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "taxonomy", array()), "tag", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag"]) {
                ...
                echo $context["tag"];
                echo "\" class=\"p-category uk-text-primary uk-margin-left\">";
                echo $context["tag"];
                echo "</a>
            ";
            }
    ...
    <div class=\"list-blog-padding uk-flex-bottom uk-margin-left uk-flex-column\">
    ...
    ";
        ...
        ";
            ...
            // line 54
            echo "        <div class=\"p-summary e-content uk-flex-column\">
            ";
            // line 55
            echo $this->getAttribute(($context["page"] ?? null), "summary", array());
            echo "
            <p><a class=\"uk-margin-left\" href=\"";
            // line 56
            echo $this->getAttribute(($context["page"] ?? null), "url", array());
...
";
    ...
    {
        return array (  253 => 87,  249 => 85,  241 => 83,  239 => 82,  236 => 81,  228 => 79,  226 => 78,  222 => 76,  220 => 75,  217 => 74,  214 => 73,  212 => 72,  209 => 71,  206 => 70,  203 => 69,  201 => 68,  195 => 65,  192 => 64,  186 => 61,  182 => 60,  179 => 59,  177 => 58,  172 => 56,  168 => 55,  165 => 54,  162 => 53,  159 => 52,  156 => 51,  154 => 50,  149 => 48,  146 => 47,  144 => 46,  137 => 41,  131 => 39,  128 => 38,  125 => 37,  122 => 36,  119 => 35,  116 => 34,  113 => 33,  109 => 31,  95 => 29,  91 => 28,  88 => 27,  86 => 26,  83 => 25,  75 => 23,  66 => 20,  60 => 18,  58 => 17,  55 => 16,  53 => 15,  47 => 12,  43 => 11,  39 => 10,  34 => 7,  31 => 6,  28 => 5,  25 => 4,  23 => 3,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("<div class=\"list-item h-entry uk-flex-top\">
    ...
    <div class=\"list-blog-header uk-flex-column-reverse uk-width-medium\">
        ...
        <span class=\"tags\">
            ...
            <a href=\"{{ blog.url|rtrim('/') }}/tag{{ config.system.param_sep }}{{ tag }}\" class=\"p-category uk-text-primary uk-margin-left\">{{ tag }}</a>
            {% endfor %}
        </span>
        {% endif %}
        {% if header_image %}
    ...
    {% elseif truncate and page.summary != page.content %}
        <div class=\"p-summary e-content uk-flex-column\">
            {{ page.summary }}
            <p><a class=\"uk-margin-left\" href=\"{{ page.url }}\">Czytaj dalej</a></p>
        </div>
    {% elseif truncate %}
        <div class=\"p-summary e-content uk-flex-column\">
            {{ page.content }}
